...
annotate service.ZZ1_C_MASTERPRODORDER with @(
    ...
    Capabilities.FilterRestrictions    : {RequiredProperties: [ProductionPlant]}
);
...
/* annotate service.ZZ1_C_COMBINEDPRODORDER with @Capabilities.SearchRestrictions: {
    Searchable: false
}; */

annotate service.ZZ1_C_COMBINEDPRODORDER with @(UI.LineItem #tableMacro2: [
    {
        $Type: 'UI.DataField',
        Value: CombinedOrder,
...
annotate service.ZZ1_C_MFG_MASTEROPER_SUM with @(UI.LineItem #tableMacroOperations: [
    {
        $Type                : 'UI.DataField',
...
annotate service.ZZ1_C_MFG_ORDEROPE with @(UI.LineItem #tableMacroOperationsorder: [
    {
        $Type: 'UI.DataField',
        Value: MaterialGroup,
        Label: 'MaterialGroup',
...
annotate service.ZZMFG_TIPO_ORDINE with @(UI.SelectionFields: [
    OrderType,
    OrderTypeName
]);

annotate service.ZC_RFM_WORKCENTERSUPPLIER with @(UI.SelectionFields: [SupplierName]);
