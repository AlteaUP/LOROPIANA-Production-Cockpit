...
sap.ui.define(
    ...
    function (PageController, JSONModel, Filter, FilterOperator, Dialog) {
        'use strict';
        ...
        return PageController.extend('productioncockpitapp.ext.view.Components', {
            ...
            //function per gestire view -> assegnazione Batch tab componenti Master - INIZIO
            onBatchViewMaster: async function (oEvent) {
                const oInput = oEvent.getSource();
                const oCtx = oInput.getBindingContext();
                const oRow = oCtx.getObject();
                const sMaterial = oRow.Material;
                const sPlant = oRow.Plant;
                const sStoragLocation = oRow.StorageLocation;

            },
            //function per gestire view -> assegnazione Batch tab componenti Master - FINE
