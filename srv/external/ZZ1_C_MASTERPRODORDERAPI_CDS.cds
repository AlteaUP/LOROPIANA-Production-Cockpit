/* checksum : 0d10b87682de431e40adfaf22875892f */
@cds.external : true
@m.IsDefaultEntityContainer : 'true'
@sap.message.scope.supported : 'true'
@sap.supported.formats : 'atom json xlsx'
service ZZ1_C_MASTERPRODORDERAPI_CDS {};
...
entity ZZ1_C_MASTERPRODORDERAPI_CDS.ZZ1_C_MASTERORDER_COMP {
...
@sap.label : 'ZZ1_C_MASTERPRODORDERAPI'
entity ZZ1_C_MASTERPRODORDERAPI_CDS.ZZ1_C_MASTERPRODORDERAPI {
  @sap.sortable : 'false'
  ...
  @sap.quickinfo : 'Unità di misura di produzione'
  @sap.semantics : 'unit-of-measure'
  ProductionUnit_1 : String(3);
  @sap.aggregation.role : 'dimension'
  @sap.display.format : 'UpperCase'
  @sap.required.in.filter : 'false'
  @sap.label : 'Esercizio stagionale'
  ProductSeasonYear_1 : String(4);
  @sap.aggregation.role : 'dimension'
  @sap.display.format : 'UpperCase'
  @sap.required.in.filter : 'false'
  @sap.label : 'Collezione'
  @sap.quickinfo : 'Collezione fashion'
  ProductCollection_1 : String(10);
  @sap.aggregation.role : 'dimension'
  @sap.display.format : 'UpperCase'
  @sap.required.in.filter : 'false'
  @sap.label : 'Stagione'
  ProductSeason_1 : String(10);
  @sap.aggregation.role : 'dimension'
  @sap.display.format : 'UpperCase'
  @sap.required.in.filter : 'false'
  @sap.label : 'Tema'
  @sap.quickinfo : 'Tema fashion'
  ProductTheme_1 : String(10);
  @sap.aggregation.role : 'dimension'
  @sap.display.format : 'UpperCase'
  @sap.required.in.filter : 'false'
  @sap.label : 'Tipo di ordine'
  ManufacturingOrderType_1 : String(4);
  @sap.aggregation.role : 'dimension'
  @sap.display.format : 'UpperCase'
  @sap.required.in.filter : 'false'
  @sap.label : 'Magazzino'
  ...
  @sap.label : 'Descrizione prodotto'
  ProductDescription_1 : String(40);
  to_ZZ1_C_MASTERORDER_COMP : Association to many ZZ1_C_MASTERPRODORDERAPI_CDS.ZZ1_C_MASTERORDER_COMP {  };
  to_ZZ1_C_MFG_MASTEROPE : Association to many ZZ1_C_MASTERPRODORDERAPI_CDS.ZZ1_C_MFG_MASTEROPE {  };
};
...
entity ZZ1_C_MASTERPRODORDERAPI_CDS.ZZ1_C_MFG_MASTEROPE {
  @sap.display.format : 'UpperCase'
  @sap.required.in.filter : 'false'
  @sap.label : 'Ordine prod. princ.'
  @sap.quickinfo : 'Numero ordine di produzione principale'
